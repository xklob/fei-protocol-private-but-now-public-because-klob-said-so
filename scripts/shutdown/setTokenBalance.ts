...
const cTokenHolders = {
  '0xd8553552f8868c1ef160eedf031cf0bcf9686945': ['0x37349d9cc523d28e6abfc03fc5f44879bc8bffd9', '10985155688905568046898444'],
  '0xbb025d470162cc5ea24daf7d4566064ee7f5f111': ['0x78041341e79693953ab49f5040d3ac8ca8cd2397', '338082618388258835526'],
  '0x7e9ce3caa9910cc048590801e64174957ed41d43': ['0x9cc46ab5a714f7cd24c59f33c5769039b5872491', '2937743814887386132100523'],
  '0x647a36d421183a0a9fa62717a64b664a24e469c7': ['0xf846ee6e8ee9a6fbf51c7c65105cabc041c048ad', '9758075848365439347827724'],
  '0xfa1057d02a0c1a4885851e3f4fd496ee7d38f56e': ['0x69db2c89974f74b4a16e54eb75884465a55f3980', '97859470371666448477'],
  '0x8e4e0257a4759559b4b1ac087fe8d80c63f20d19': ['0x061c8610a784b8a1599de5b1157631e35180d818', '9060164702778291785626922'],
  '0x6f95d4d251053483f41c8718c30f4f3c404a8cf2': ['0x66f4856f1bbd1eb09e1c8d9d646f5a3a193da569', '1670178907345'],
  '0x3e5c122ffa75a9fe16ec0c69f7e9149203ea1a5d': ['0x96665d63c1b53f8335e3c9287ee255f306c93c45', '3180817495522415648434098'],
  '0x51ff03410a0da915082af444274c381bd1b4cdb1': ['0x7189b2ea41d406c5044865685fedb615626f9afd', '34519307029013765771202'],
  '0xb7fe5f277058b3f9eabf6e0655991f10924bfa54': ['0x9538d438d506fc426db37fb83dac2a0752a02757', '12500000000000'],
  '0x9de558fce4f289b305e38abe2169b75c626c114e': ['0x96665d63c1b53f8335e3c9287ee255f306c93c45', '2752643169448372736828134'],
  '0xda396c927e3e6bef77a98f372ce431b49edec43d': ['0x91f50e3183a8cc30d2a981c3afa85a2bf6691c67', '1000000000000000000000000'],
  ...
  '0x26267e41ceca7c8e0f143554af707336f27fa051': ['0x66b870ddf78c975af5cd8edc6de25eca81791de1', '3759929116760149574446'],
  ...
  '0x8922c1147e141c055fddfc0ed5a119f3378c8ef8': ['0x96665d63c1b53f8335e3c9287ee255f306c93c45', '10547551798004181955188852'],
  '0x7dbc3af9251756561ce755fcc11c754184af71f7': ['0xbf2647e5319cfbbe840ad0fafbe5e073e89b40f0', '2500000000000000000000'],
  '0x3a2804ec0ff521374af654d8d0daa1d1ae1ee900': ['0x11b1f3c622b129212d257d603d312244820cc367', '3486298653412255041116763'],
  '0xa54c548d11792b3d26ad74f5f899e12cdfd64fd6': ['0x69b9a89083e2324079922e01557cafb87cd90b09', '3993531603381679285712741'],
  '0xa6c25548df506d84afd237225b5b34f2feb1aa07': ['0x2d160210011a992966221f428f63326f76066ba9', '4253125418166470353171372'],
  '0xfbd8aaf46ab3c2732fa930e5b343cd67cea5054c': ['0xc68412b72e68c30d4e6c0854b439cbbe957146e4', '11960303655355917097801'],
  '0x001e407f497e024b9fb1cb93ef841f43d645ca4f': ['0x525ea5983a2e02aba8aa0be7d15cd73150812379', '33609562056018421713210980'],
  '0x5cadc2a04921213de60b237688776e0f1a7155e6': ['0x96665d63c1b53f8335e3c9287ee255f306c93c45', '28499508944344457687075380'],
...
async function main() {
  if (process.argv[2] === 'help') {
    console.log(`
      ...
      Examples: 
        npx ts-node scripts/setTokenBalance 0xd8553552f8868c1ef160eedf031cf0bcf9686945 0x11e52c75998fe2E7928B191bfc5B25937Ca16741
        npx ts-node scripts/shutdown/resetFork.ts 0xd8553552f8868c1ef160eedf031cf0bcf9686945 0x11e52c75998fe2E7928B191bfc5B25937Ca16741 1000 true
    `);
    return;
  }
  ...
  if (debug) {
    for (const cTokenAddress of Object.keys(cTokenHolders)) {
      ...
      if (topHolderActualBalance.lt(BigNumber.from('100000'))) {
        throw new Error(`Error: Top holder balance for cToken ${cTokenAddress} too low for testing: ${topHolderActualBalance.toNumber()}`);
      }
