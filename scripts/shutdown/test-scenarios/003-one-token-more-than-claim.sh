...
npx ts-node scripts/shutdown/createMerkleTree scripts/shutdown/data/sample/snapshot.json scripts/shutdown/data/test/roots.json true scripts/shutdown/data/sample/testingSnapshot.json
