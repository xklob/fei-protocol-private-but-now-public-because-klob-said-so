...
npx ts-node scripts/shutdown/createMerkleTree scripts/shutdown/data/sample/snapshot.json scripts/shutdown/data/test/roots.json true scripts/shutdown/test-scenarios/005-multiple-ctokens.json
